...
/*===================================
	CONSTRUCTOR 
====================================*/
 function Doctor (id, uid, firstName, midName, lastName, title, specialty1, specialty2, practice, medSchool, residency, fellowship, pub, years, trials, stars, awards, score, removed) {
 	this.id = id; 
 	this.uid = uid;
...
function log(i){
	...
	fs.appendFile("../db/doctors.csv", doctors[i].id + "," + doctors[i].uid + "," + doctors[i].firstName + "," + doctors[i].midName + "," +
  			...
  			doctors[i].awards + "," + doctors[i].score + "," + doctors[i].removed + "\n", function(err) {
